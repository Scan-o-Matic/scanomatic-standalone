...
def add_routes(app, rpc_client):
    ...
    def _feature_extract_bioscreen_api():
        ...
        time_scale = data_object.get("bioscreen_timescale", 36000)
        try:
        ...
        try_keep_qc = bool(data_object.get("try_keep_qc", False))
        ...
        success = (
            FeaturesFactory.validate(model)
    ...
    def _analysis_api():
        ...
        if (
            ...
            or path_compile_instructions == "root/"
        ):
        ...
        regridding_folder = data_object.get("reference_grid_folder", None)
        ...
        plate_image_inclusion = data_object.get('plate_image_inclusion', [])
        ...
        if plate_image_inclusion:
            ...
            if isinstance(plate_image_inclusion, StringTypes):
                ...
                plate_image_inclusion = [
                    val if val else None for val in plate_image_inclusion
                ]
    ...
    def _experiment_api():
        ...
        m = ScanningModelFactory.create(
            ...
            scanner_hardware=data_object.get(
                "scanner_hardware",
                "EPSON V800",
            ),
    ...
    def _compile_api():
        ...
        if images:
            ...
            if len(dict_model['images']) != len(images):
                return json_abort(
                    400,
                    reason="The manually set list of images could not be satisfied"  # noqa: E501
